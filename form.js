const htmlForm = `<form id="elitedermaForm" name="elitedermaForm" target="/">
  ...
  <div>
    ...
    <span
      class="error"
      style="display: none; font-size: 0.8em; position: absolute; color: red"
  ...
  <div>
    ...
    />
    <label for="corso3">Corso trucco permanente con dermografo Base</label
    ><br />
    <input
      type="checkbox"
      class="info"
    ...
    />
    <label for="corso4">Corso trucco permanente con dermografo Avanzato</label
    ><br />
    <input
      type="checkbox"
      class="info"
  ...
  <select
    ...
    style="min-width: 20%; border: 1px solid #ccc; padding: 10px"
  >
  ...
  >
    ...
    <option value="Sabato">Sabato</option></select
  ><br />
  <br />
  ...
  <select
    ...
    aria-invalid="false"
    name="menu-ora"
    style="min-width: 25%; border: 1px solid #ccc; padding: 10px"
  >
    <option value="">—Seleziona un'opzione—</option>
    ...
    <option value="19.30-20.00">19.30-20.00</option></select
  ><br />
  <br />

  <p style="font-size: 11px; padding-bottom: 5px">
    Si applica la nostra
    <a href="/j/privacy" target="_blank">Dichiarazione sulla privacy</a>
  </p>
